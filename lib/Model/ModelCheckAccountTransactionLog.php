 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class ModelCheckAccountTransactionLog implements ModelInterface, ArrayAccess
{
    ...
    protected static $swaggerTypes = [
        'create' => '\DateTime',
        'check_account_transaction' => '\Swagger\Client\Model\ModelCheckAccountTransaction',
        'from_status' => 'int',
        'to_status' => 'int',
        'amount_paid' => 'float',
     ...
     * Sets create
     *
     * @param \DateTime $create date the check account transaction log was created
     *
     * @return $this
     */
     ...
     *
     * @param \Swagger\Client\Model\ModelCheckAccountTransaction $check_account_transaction the check account transaction to which the log refers
     *
     * @return $this
     */
     ...
     * Sets from_status
     *
     * @param int $from_status the status before the logged change
     *
     * @return $this
     */
     ...
     * Sets to_status
     *
     * @param int $to_status the status after the logged change
     *
     * @return $this
     */
     ...
     * Sets amount_paid
     *
     * @param float $amount_paid the logged amount which was paid
     *
     * @return $this
     */
     ...
     * Sets object
     *
     * @param object $object Invoice/Voucher to which the logged transaction belongs
     *
     * @return $this
     */
