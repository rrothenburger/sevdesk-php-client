...
class FeedApi
{
    ...
    public function addFeedWithHttpInfo($body)
    {
        ...
        $request = $this->addFeedRequest($body);
     ...
     */
    public function addFeedAsync($body)
    {
        return $this->addFeedAsyncWithHttpInfo($body)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation addFeedAsyncWithHttpInfo
     *
     * Create a new action which will be displayed in the feed
     *
     * @param  string $body To create a new action for the feed, simply enter desired values after parameter&#x3D; and remove the quotation marks. (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function addFeedAsyncWithHttpInfo($body)
    {
        $returnType = '\Swagger\Client\Model\ModelFeed';
        $request = $this->addFeedRequest($body);
    ...
    /**
     * Create request for operation 'addFeed'
     *
     * @param  string $body To create a new action for the feed, simply enter desired values after parameter&#x3D; and remove the quotation marks. (required)
     *
     * @throws \InvalidArgumentException
     ...
     */
    protected function addFeedRequest($body)
    {
        // verify the required parameter 'body' is set
        if ($body === null || (is_array($body) && count($body) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $body when calling addFeed'
            );
        }
    ...
    {
        $this->deleteFeedWithHttpInfo($id);
    }
    ...
    {
        $returnType = '';
        $request = $this->deleteFeedRequest($id);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function deleteFeedAsync($id)
    {
        return $this->deleteFeedAsyncWithHttpInfo($id)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function deleteFeedAsyncWithHttpInfo($id)
    {
        $returnType = '';
        $request = $this->deleteFeedRequest($id);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function deleteFeedRequest($id)
    {
    ...
    {
        $returnType = '\Swagger\Client\Model\ModelFeed';
        $request = $this->getFeedsRequest($limit, $offset, $embed);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getFeedsAsync($limit = '100', $offset = '0', $embed = null)
    {
        return $this->getFeedsAsyncWithHttpInfo($limit, $offset, $embed)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getFeedsAsyncWithHttpInfo($limit = '100', $offset = '0', $embed = null)
    {
        $returnType = '\Swagger\Client\Model\ModelFeed';
        $request = $this->getFeedsRequest($limit, $offset, $embed);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function getFeedsRequest($limit = '100', $offset = '0', $embed = null)
    {
    ...
    {
        $this->getParsedObjectActionWithHttpInfo($id);
    }
    ...
    {
        $returnType = '';
        $request = $this->getParsedObjectActionRequest($id);
    ...
    /**
     * Operation getParsedObjectActionAsync
     *
     * Get more information about the specific feed object
     *
     * @param  int $id Feed id of the object you want to get more information about (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getParsedObjectActionAsync($id)
    {
        return $this->getParsedObjectActionAsyncWithHttpInfo($id)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation getParsedObjectActionAsyncWithHttpInfo
     *
     * Get more information about the specific feed object
     *
     * @param  int $id Feed id of the object you want to get more information about (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getParsedObjectActionAsyncWithHttpInfo($id)
    {
        $returnType = '';
        $request = $this->getParsedObjectActionRequest($id);
    ...
    /**
     * Create request for operation 'getParsedObjectAction'
     *
     * @param  int $id Feed id of the object you want to get more information about (required)
     *
     * @throws \InvalidArgumentException
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function getParsedObjectActionRequest($id)
    {
        // verify the required parameter 'id' is set
        if ($id === null || (is_array($id) && count($id) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $id when calling getParsedObjectAction'
            );
        }
    ...
    {
        $returnType = '\Swagger\Client\Model\ModelFeed';
        $request = $this->updateFeedRequest($id, $body);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function updateFeedAsync($id, $body = null)
    {
        return $this->updateFeedAsyncWithHttpInfo($id, $body)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function updateFeedAsyncWithHttpInfo($id, $body = null)
    {
        $returnType = '\Swagger\Client\Model\ModelFeed';
        $request = $this->updateFeedRequest($id, $body);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function updateFeedRequest($id, $body = null)
    {
        // verify the required parameter 'id' is set
        if ($id === null || (is_array($id) && count($id) === 0)) {
            throw new \InvalidArgumentException(
