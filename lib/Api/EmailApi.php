...
class EmailApi
{
    ...
    public function addEmailWithHttpInfo($body)
    {
        ...
        $request = $this->addEmailRequest($body);
     ...
     */
    public function addEmailAsync($body)
    {
        return $this->addEmailAsyncWithHttpInfo($body)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function addEmailAsyncWithHttpInfo($body)
    {
        $returnType = '\Swagger\Client\Model\ModelEmail';
        $request = $this->addEmailRequest($body);
     ...
     */
    protected function addEmailRequest($body)
    {
    ...
    {
        $this->deleteEmailWithHttpInfo($id);
    }
    ...
    {
        $returnType = '\Swagger\Client\Model\ModelEmail';
        $request = $this->getEmailsRequest($limit, $offset, $embed);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getEmailsAsync($limit = '100', $offset = '0', $embed = null)
    {
        return $this->getEmailsAsyncWithHttpInfo($limit, $offset, $embed)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getEmailsAsyncWithHttpInfo($limit = '100', $offset = '0', $embed = null)
    {
        $returnType = '\Swagger\Client\Model\ModelEmail';
        $request = $this->getEmailsRequest($limit, $offset, $embed);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function getEmailsRequest($limit = '100', $offset = '0', $embed = null)
    {
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function updateEmailAsync($id, $body = null)
    {
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function updateEmailAsyncWithHttpInfo($id, $body = null)
    {
        $returnType = '\Swagger\Client\Model\ModelEmail';
        $request = $this->updateEmailRequest($id, $body);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function updateEmailRequest($id, $body = null)
    {
        // verify the required parameter 'id' is set
        if ($id === null || (is_array($id) && count($id) === 0)) {
            throw new \InvalidArgumentException(
