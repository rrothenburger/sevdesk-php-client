...
class CurrencyExchangeRateApi
{
     ...
     * @return \Swagger\Client\Model\ModelCurrencyExchangeRate
     */
     ...
     * @throws \Swagger\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Swagger\Client\Model\ModelCurrencyExchangeRate, HTTP status code, HTTP response headers (array of strings)
     */
    public function getCurrencyExchangeRatesWithHttpInfo($limit = '1000', $offset = '0')
    {
        $returnType = '\Swagger\Client\Model\ModelCurrencyExchangeRate';
        $request = $this->getCurrencyExchangeRatesRequest($limit, $offset);
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Swagger\Client\Model\ModelCurrencyExchangeRate',
    ...
    /**
     * Operation getCurrencyExchangeRatesAsync
     *
     * Get an overview of all currency exchange rates
     *
     * @param  int $limit Limits the number of entries returned. Default is 1000.    Be aware that there are over 100000 entries in the database for currency exchange rate, so using a limit higher than 1000 with offset&#x3D;0 is not recommended!    However you can set the offset appropriately so you minimize the amount of returned exchange rates and keep loading time to a low. (optional, default to 1000)
     ...
     */
    public function getCurrencyExchangeRatesAsync($limit = '1000', $offset = '0')
    {
        return $this->getCurrencyExchangeRatesAsyncWithHttpInfo($limit, $offset)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation getCurrencyExchangeRatesAsyncWithHttpInfo
     *
     * Get an overview of all currency exchange rates
     *
     * @param  int $limit Limits the number of entries returned. Default is 1000.    Be aware that there are over 100000 entries in the database for currency exchange rate, so using a limit higher than 1000 with offset&#x3D;0 is not recommended!    However you can set the offset appropriately so you minimize the amount of returned exchange rates and keep loading time to a low. (optional, default to 1000)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getCurrencyExchangeRatesAsyncWithHttpInfo($limit = '1000', $offset = '0')
    {
        $returnType = '\Swagger\Client\Model\ModelCurrencyExchangeRate';
        $request = $this->getCurrencyExchangeRatesRequest($limit, $offset);
    ...
    /**
     * Create request for operation 'getCurrencyExchangeRates'
     *
     * @param  int $limit Limits the number of entries returned. Default is 1000.    Be aware that there are over 100000 entries in the database for currency exchange rate, so using a limit higher than 1000 with offset&#x3D;0 is not recommended!    However you can set the offset appropriately so you minimize the amount of returned exchange rates and keep loading time to a low. (optional, default to 1000)
     * @param  int $offset Set the index where the returned currency exchange rates start. Default is 0 (optional, default to 0)
     *
     ...
     */
    protected function getCurrencyExchangeRatesRequest($limit = '1000', $offset = '0')
    {
