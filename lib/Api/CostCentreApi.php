...
class CostCentreApi
{
     ...
     * @throws \Swagger\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Swagger\Client\Model\ModelCostCentre, HTTP status code, HTTP response headers (array of strings)
     */
    public function addCostCentreWithHttpInfo($body)
    {
        $returnType = '\Swagger\Client\Model\ModelCostCentre';
        $request = $this->addCostCentreRequest($body);
            ...
            switch ($e->getCode()) {
                case 201:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Swagger\Client\Model\ModelCostCentre',
     ...
     */
    public function addCostCentreAsync($body)
    {
        return $this->addCostCentreAsyncWithHttpInfo($body)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation addCostCentreAsyncWithHttpInfo
     *
     * Create a new cost centre
     *
     * @param  string $body To create a cost centre, simply enter desired values after parameter&#x3D; and remove the quotation marks (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function addCostCentreAsyncWithHttpInfo($body)
    {
        $returnType = '\Swagger\Client\Model\ModelCostCentre';
        $request = $this->addCostCentreRequest($body);
    ...
    /**
     * Create request for operation 'addCostCentre'
     *
     * @param  string $body To create a cost centre, simply enter desired values after parameter&#x3D; and remove the quotation marks (required)
     *
     * @throws \InvalidArgumentException
     ...
     */
    protected function addCostCentreRequest($body)
    {
        // verify the required parameter 'body' is set
        if ($body === null || (is_array($body) && count($body) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $body when calling addCostCentre'
            );
        }
    ...
    {
        $this->deleteCostCentreWithHttpInfo($id);
    }
    ...
    {
        $returnType = '\Swagger\Client\Model\ModelCostCentre';
        $request = $this->getCostCentreRequest($limit, $offset, $embed);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getCostCentreAsync($limit = '100', $offset = '0', $embed = null)
    {
        return $this->getCostCentreAsyncWithHttpInfo($limit, $offset, $embed)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getCostCentreAsyncWithHttpInfo($limit = '100', $offset = '0', $embed = null)
    {
        $returnType = '\Swagger\Client\Model\ModelCostCentre';
        $request = $this->getCostCentreRequest($limit, $offset, $embed);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function getCostCentreRequest($limit = '100', $offset = '0', $embed = null)
    {
    ...
    {
        $returnType = '\Swagger\Client\Model\ModelCostCentre';
        $request = $this->updateCostCentreRequest($id, $body);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function updateCostCentreAsync($id, $body = null)
    {
        return $this->updateCostCentreAsyncWithHttpInfo($id, $body)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function updateCostCentreAsyncWithHttpInfo($id, $body = null)
    {
        $returnType = '\Swagger\Client\Model\ModelCostCentre';
        $request = $this->updateCostCentreRequest($id, $body);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function updateCostCentreRequest($id, $body = null)
    {
        // verify the required parameter 'id' is set
        if ($id === null || (is_array($id) && count($id) === 0)) {
            throw new \InvalidArgumentException(
