...
class TaskApi
{
    ...
    public function addTaskWithHttpInfo($body)
    {
        ...
        $request = $this->addTaskRequest($body);
     ...
     */
    public function addTaskAsync($body)
    {
        return $this->addTaskAsyncWithHttpInfo($body)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function addTaskAsyncWithHttpInfo($body)
    {
        $returnType = '\Swagger\Client\Model\ModelOrderPos';
        $request = $this->addTaskRequest($body);
     ...
     */
    protected function addTaskRequest($body)
    {
        // verify the required parameter 'body' is set
        if ($body === null || (is_array($body) && count($body) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $body when calling addTask'
            );
        }
     ...
     * @throws \Swagger\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Swagger\Client\Model\ModelTask
     */
     ...
     * @throws \Swagger\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Swagger\Client\Model\ModelTask, HTTP status code, HTTP response headers (array of strings)
     */
    public function getTasksWithHttpInfo($limit = '100', $offset = '0', $embed = null)
    {
        $returnType = '\Swagger\Client\Model\ModelTask';
        $request = $this->getTasksRequest($limit, $offset, $embed);
        ...
        try {
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Swagger\Client\Model\ModelTask',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getTasksAsync($limit = '100', $offset = '0', $embed = null)
    {
        return $this->getTasksAsyncWithHttpInfo($limit, $offset, $embed)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getTasksAsyncWithHttpInfo($limit = '100', $offset = '0', $embed = null)
    {
        $returnType = '\Swagger\Client\Model\ModelTask';
        $request = $this->getTasksRequest($limit, $offset, $embed);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function getTasksRequest($limit = '100', $offset = '0', $embed = null)
    {
