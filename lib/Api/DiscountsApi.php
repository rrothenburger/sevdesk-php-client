...
class DiscountsApi
{
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function deleteDiscountAsync($id)
    {
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function deleteDiscountAsyncWithHttpInfo($id)
    {
        $returnType = '';
        $request = $this->deleteDiscountRequest($id);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function deleteDiscountRequest($id)
    {
        // verify the required parameter 'id' is set
        if ($id === null || (is_array($id) && count($id) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $id when calling deleteDiscount'
            );
        }
    ...
    {
        $returnType = '\Swagger\Client\Model\ModelDiscounts';
        $request = $this->getDiscountsRequest($limit, $offset, $embed);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getDiscountsAsync($limit = '100', $offset = '0', $embed = null)
    {
        return $this->getDiscountsAsyncWithHttpInfo($limit, $offset, $embed)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getDiscountsAsyncWithHttpInfo($limit = '100', $offset = '0', $embed = null)
    {
        $returnType = '\Swagger\Client\Model\ModelDiscounts';
        $request = $this->getDiscountsRequest($limit, $offset, $embed);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function getDiscountsRequest($limit = '100', $offset = '0', $embed = null)
    {
    ...
    {
        $returnType = '\Swagger\Client\Model\ModelDiscounts';
        $request = $this->updateDiscountRequest($id, $body);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function updateDiscountAsync($id, $body = null)
    {
        return $this->updateDiscountAsyncWithHttpInfo($id, $body)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function updateDiscountAsyncWithHttpInfo($id, $body = null)
    {
        $returnType = '\Swagger\Client\Model\ModelDiscounts';
        $request = $this->updateDiscountRequest($id, $body);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function updateDiscountRequest($id, $body = null)
    {
        // verify the required parameter 'id' is set
        if ($id === null || (is_array($id) && count($id) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $id when calling updateDiscount'
            );
        }
