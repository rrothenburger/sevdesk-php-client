...
class VoucherLogApi
{
    ...
    public function addVoucherLogEntryWithHttpInfo($body)
    {
        ...
        $request = $this->addVoucherLogEntryRequest($body);
    ...
    /**
     * Operation addVoucherLogEntryAsync
     *
     * Create a new voucher log entry
     *
     * @param  string $body To create a voucher, simply enter desired values after parameter&#x3D; and remove the quotation marks. (required)
     ...
     */
    public function addVoucherLogEntryAsync($body)
    {
        return $this->addVoucherLogEntryAsyncWithHttpInfo($body)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation addVoucherLogEntryAsyncWithHttpInfo
     *
     * Create a new voucher log entry
     *
     * @param  string $body To create a voucher, simply enter desired values after parameter&#x3D; and remove the quotation marks. (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function addVoucherLogEntryAsyncWithHttpInfo($body)
    {
        $returnType = '\Swagger\Client\Model\ModelVoucherLog';
        $request = $this->addVoucherLogEntryRequest($body);
    ...
    /**
     * Create request for operation 'addVoucherLogEntry'
     *
     * @param  string $body To create a voucher, simply enter desired values after parameter&#x3D; and remove the quotation marks. (required)
     *
     * @throws \InvalidArgumentException
     ...
     */
    protected function addVoucherLogEntryRequest($body)
    {
        // verify the required parameter 'body' is set
        if ($body === null || (is_array($body) && count($body) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $body when calling addVoucherLogEntry'
            );
        }
    ...
    {
        $this->deleteVoucherLogEntryWithHttpInfo($id);
    }
    ...
    {
        $returnType = '';
        $request = $this->deleteVoucherLogEntryRequest($id);
    ...
    /**
     * Operation deleteVoucherLogEntryAsync
     *
     * Delete an existing voucher log entry
     *
     * @param  int $id Id of voucher log entry you want to delete (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function deleteVoucherLogEntryAsync($id)
    {
        return $this->deleteVoucherLogEntryAsyncWithHttpInfo($id)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation deleteVoucherLogEntryAsyncWithHttpInfo
     *
     * Delete an existing voucher log entry
     *
     * @param  int $id Id of voucher log entry you want to delete (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function deleteVoucherLogEntryAsyncWithHttpInfo($id)
    {
        $returnType = '';
        $request = $this->deleteVoucherLogEntryRequest($id);
    ...
    /**
     * Create request for operation 'deleteVoucherLogEntry'
     *
     * @param  int $id Id of voucher log entry you want to delete (required)
     *
     * @throws \InvalidArgumentException
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function deleteVoucherLogEntryRequest($id)
    {
        // verify the required parameter 'id' is set
        if ($id === null || (is_array($id) && count($id) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $id when calling deleteVoucherLogEntry'
            );
        }
    ...
    {
        $returnType = '\Swagger\Client\Model\ModelVoucherLog';
        $request = $this->getVoucherLogRequest($limit, $offset, $embed);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getVoucherLogAsync($limit = '100', $offset = '0', $embed = null)
    {
        return $this->getVoucherLogAsyncWithHttpInfo($limit, $offset, $embed)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation getVoucherLogAsyncWithHttpInfo
     *
     * Get an overview of all voucher log entries
     *
     * @param  int $limit Limits the number of entries returned. Default is 100 (optional, default to 100)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getVoucherLogAsyncWithHttpInfo($limit = '100', $offset = '0', $embed = null)
    {
        $returnType = '\Swagger\Client\Model\ModelVoucherLog';
        $request = $this->getVoucherLogRequest($limit, $offset, $embed);
    ...
    /**
     * Create request for operation 'getVoucherLog'
     *
     * @param  int $limit Limits the number of entries returned. Default is 100 (optional, default to 100)
     * @param  int $offset Set the index where the returned voucher log entries start. Default is 0 (optional, default to 0)
     * @param  string[] $embed Get some additional information. Embed can handle multiple values, they must be separated by comma. Default &#x60;&#x60;. (optional)
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function getVoucherLogRequest($limit = '100', $offset = '0', $embed = null)
    {
    ...
    {
        $returnType = '\Swagger\Client\Model\ModelVoucherLog';
        $request = $this->updateVoucherLogEntryRequest($id, $body);
    ...
    /**
     * Operation updateVoucherLogEntryAsync
     *
     * Update an existing voucher log entry
     *
     * @param  int $id Id of the voucher log entry you want to update (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function updateVoucherLogEntryAsync($id, $body = null)
    {
        return $this->updateVoucherLogEntryAsyncWithHttpInfo($id, $body)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation updateVoucherLogEntryAsyncWithHttpInfo
     *
     * Update an existing voucher log entry
     *
     * @param  int $id Id of the voucher log entry you want to update (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function updateVoucherLogEntryAsyncWithHttpInfo($id, $body = null)
    {
        $returnType = '\Swagger\Client\Model\ModelVoucherLog';
        $request = $this->updateVoucherLogEntryRequest($id, $body);
    ...
    /**
     * Create request for operation 'updateVoucherLogEntry'
     *
     * @param  int $id Id of the voucher log entry you want to update (required)
     * @param  string $body Parameters which need to be updated. Please refer to the description from create voucher log entry.    Enter the parameters according to the syntax: parameter1&#x3D;&amp;parameter2&#x3D; and remove the quotation marks (optional)
     *
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function updateVoucherLogEntryRequest($id, $body = null)
    {
        // verify the required parameter 'id' is set
        if ($id === null || (is_array($id) && count($id) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $id when calling updateVoucherLogEntry'
            );
        }
