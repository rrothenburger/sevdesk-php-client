...
class TextTemplateApi
{
     ...
     * @return \Swagger\Client\Model\ModelTextTemplate
     */
     ...
     * @throws \Swagger\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Swagger\Client\Model\ModelTextTemplate, HTTP status code, HTTP response headers (array of strings)
     */
    public function addTextTemplateWithHttpInfo($body)
    {
        $returnType = '\Swagger\Client\Model\ModelTextTemplate';
        $request = $this->addTextTemplateRequest($body);
            ...
            switch ($e->getCode()) {
                case 201:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Swagger\Client\Model\ModelTextTemplate',
     ...
     */
    public function addTextTemplateAsync($body)
    {
        return $this->addTextTemplateAsyncWithHttpInfo($body)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function addTextTemplateAsyncWithHttpInfo($body)
    {
        $returnType = '\Swagger\Client\Model\ModelTextTemplate';
        $request = $this->addTextTemplateRequest($body);
     ...
     */
    protected function addTextTemplateRequest($body)
    {
        // verify the required parameter 'body' is set
        if ($body === null || (is_array($body) && count($body) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $body when calling addTextTemplate'
            );
        }
    ...
    {
        $this->deleteTextTemplateWithHttpInfo($id);
    }
    ...
    {
        $returnType = '';
        $request = $this->deleteTextTemplateRequest($id);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function deleteTextTemplateAsync($id)
    {
        return $this->deleteTextTemplateAsyncWithHttpInfo($id)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function deleteTextTemplateAsyncWithHttpInfo($id)
    {
        $returnType = '';
        $request = $this->deleteTextTemplateRequest($id);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function deleteTextTemplateRequest($id)
    {
    ...
    {
        $returnType = '\Swagger\Client\Model\ModelTextTemplate';
        $request = $this->getTextTemplateRequest($limit, $offset, $embed);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getTextTemplateAsync($limit = '100', $offset = '0', $embed = null)
    {
        return $this->getTextTemplateAsyncWithHttpInfo($limit, $offset, $embed)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getTextTemplateAsyncWithHttpInfo($limit = '100', $offset = '0', $embed = null)
    {
        $returnType = '\Swagger\Client\Model\ModelTextTemplate';
        $request = $this->getTextTemplateRequest($limit, $offset, $embed);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function getTextTemplateRequest($limit = '100', $offset = '0', $embed = null)
    {
    ...
    {
        $returnType = '\Swagger\Client\Model\ModelTextTemplate';
        $request = $this->updateTextTemplateRequest($id, $body);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function updateTextTemplateAsync($id, $body = null)
    {
        return $this->updateTextTemplateAsyncWithHttpInfo($id, $body)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function updateTextTemplateAsyncWithHttpInfo($id, $body = null)
    {
        $returnType = '\Swagger\Client\Model\ModelTextTemplate';
        $request = $this->updateTextTemplateRequest($id, $body);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function updateTextTemplateRequest($id, $body = null)
    {
        // verify the required parameter 'id' is set
        if ($id === null || (is_array($id) && count($id) === 0)) {
            throw new \InvalidArgumentException(
