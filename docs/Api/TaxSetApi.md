...
# **addTaxSet**
> \Swagger\Client\Model\ModelTaxSet addTaxSet($body)
...
$apiInstance = new Swagger\Client\Api\TaxSetApi(
...
try {
    $result = $apiInstance->addTaxSet($body);
    print_r($result);
} catch (Exception $e) {
...
[**\Swagger\Client\Model\ModelTaxSet**](../Model/ModelTaxSet.md)
...
# **getTaxSets**
> \Swagger\Client\Model\ModelTaxSet getTaxSets($limit, $offset, $embed)
...
try {
    $result = $apiInstance->getTaxSets($limit, $offset, $embed);
    print_r($result);
} catch (Exception $e) {
...
# **updateTaxSet**
> \Swagger\Client\Model\ModelTaxSet updateTaxSet($id, $body)
...
try {
    $result = $apiInstance->updateTaxSet($id, $body);
    print_r($result);
} catch (Exception $e) {
