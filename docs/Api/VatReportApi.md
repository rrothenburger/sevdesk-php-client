...
$apiInstance = new Swagger\Client\Api\VatReportApi(
...
try {
    $apiInstance->getVatReport($reporting_year, $reporting_period_code, $no_actual_taxation_on_input_tax);
} catch (Exception $e) {
