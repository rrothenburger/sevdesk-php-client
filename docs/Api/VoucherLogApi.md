...
# **addVoucherLogEntry**
> \Swagger\Client\Model\ModelVoucherLog addVoucherLogEntry($body)
...
$apiInstance = new Swagger\Client\Api\VoucherLogApi(
...
try {
    $result = $apiInstance->addVoucherLogEntry($body);
    print_r($result);
} catch (Exception $e) {
...
# **getVoucherLog**
> \Swagger\Client\Model\ModelVoucherLog getVoucherLog($limit, $offset, $embed)
...
try {
    $result = $apiInstance->getVoucherLog($limit, $offset, $embed);
    print_r($result);
} catch (Exception $e) {
...
> \Swagger\Client\Model\ModelVoucherLog updateVoucherLogEntry($id, $body)
...
try {
    $result = $apiInstance->updateVoucherLogEntry($id, $body);
    print_r($result);
} catch (Exception $e) {
