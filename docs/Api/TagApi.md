...
# **addTag**
> \Swagger\Client\Model\ModelTag addTag($body)
...
try {
    $result = $apiInstance->addTag($body);
    print_r($result);
} catch (Exception $e) {
...
# **getTags**
> \Swagger\Client\Model\ModelTag getTags($limit, $offset, $embed)
...
try {
    $result = $apiInstance->getTags($limit, $offset, $embed);
    print_r($result);
} catch (Exception $e) {
...
# **updateTag**
> \Swagger\Client\Model\ModelTag updateTag($id, $body)
