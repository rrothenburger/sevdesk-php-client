...
> \Swagger\Client\Model\ModelCheckAccountTransaction addCheckAccountTransaction($body)
...
try {
    $result = $apiInstance->addCheckAccountTransaction($body);
    print_r($result);
} catch (Exception $e) {
...
> \Swagger\Client\Model\ModelCheckAccountTransactionLog checkAccountTransactionGetLog($id, $embed)
...
try {
    $result = $apiInstance->checkAccountTransactionGetLog($id, $embed);
    print_r($result);
} catch (Exception $e) {
...
> \Swagger\Client\Model\ModelCheckAccountTransaction getCheckAccountTransactions($limit, $offset, $embed)
...
try {
    $result = $apiInstance->getCheckAccountTransactions($limit, $offset, $embed);
    print_r($result);
} catch (Exception $e) {
...
> \Swagger\Client\Model\ModelCheckAccountTransaction linkInvoiceToCheckAccountTransaction($id, $body)
...
try {
    $result = $apiInstance->linkInvoiceToCheckAccountTransaction($id, $body);
    print_r($result);
} catch (Exception $e) {
...
> \Swagger\Client\Model\ModelCheckAccountTransaction linkVoucherToCheckAccountTransaction($id, $body)
...
try {
    $result = $apiInstance->linkVoucherToCheckAccountTransaction($id, $body);
    print_r($result);
} catch (Exception $e) {
...
> \Swagger\Client\Model\ModelCheckAccountTransaction updateCheckAccountTransaction($id, $body)
...
try {
    $result = $apiInstance->updateCheckAccountTransaction($id, $body);
    print_r($result);
} catch (Exception $e) {
...
> \Swagger\Client\Model\ModelCheckAccountTransaction updateCheckAccountTransactionStatus($id, $body)
...
try {
    $result = $apiInstance->updateCheckAccountTransactionStatus($id, $body);
    print_r($result);
} catch (Exception $e) {
