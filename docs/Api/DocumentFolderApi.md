# Swagger\Client\DocumentFolderApi
...
# **addDocumentFolder**
> \Swagger\Client\Model\ModelDocumentFolder addDocumentFolder($body)
...
$apiInstance = new Swagger\Client\Api\DocumentFolderApi(
...
try {
    $result = $apiInstance->addDocumentFolder($body);
    print_r($result);
} catch (Exception $e) {
...
[**\Swagger\Client\Model\ModelDocumentFolder**](../Model/ModelDocumentFolder.md)
...
> \Swagger\Client\Model\ModelDocumentFolder getDocumentFolderChildren($id, $limit, $offset, $embed)
...
try {
    $result = $apiInstance->getDocumentFolderChildren($id, $limit, $offset, $embed);
    print_r($result);
} catch (Exception $e) {
...
> \Swagger\Client\Model\ModelDocumentFolder getDocumentFolderDocuments($id, $limit, $offset, $embed)
...
try {
    $result = $apiInstance->getDocumentFolderDocuments($id, $limit, $offset, $embed);
    print_r($result);
} catch (Exception $e) {
...
> \Swagger\Client\Model\ModelDocumentFolder getDocumentFolderFolders($id, $limit, $offset, $embed)
...
try {
    $result = $apiInstance->getDocumentFolderFolders($id, $limit, $offset, $embed);
    print_r($result);
} catch (Exception $e) {
...
> \Swagger\Client\Model\ModelDocumentFolder getDocumentFolderPath($id)
...
try {
    $result = $apiInstance->getDocumentFolderPath($id);
    print_r($result);
} catch (Exception $e) {
...
# **getDocumentFolders**
> \Swagger\Client\Model\ModelDocumentFolder getDocumentFolders($limit, $offset, $embed)
...
try {
    $result = $apiInstance->getDocumentFolders($limit, $offset, $embed);
    print_r($result);
} catch (Exception $e) {
...
> \Swagger\Client\Model\ModelDocumentFolder updateDocumentFolder($id, $body)
...
try {
    $result = $apiInstance->updateDocumentFolder($id, $body);
    print_r($result);
} catch (Exception $e) {
