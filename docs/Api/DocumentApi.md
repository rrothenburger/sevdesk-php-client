...
# **addDocument**
> \Swagger\Client\Model\ModelDocument addDocument($body)
...
[**\Swagger\Client\Model\ModelDocument**](../Model/ModelDocument.md)
...
# **getDocuments**
> \Swagger\Client\Model\ModelDocument getDocuments($limit, $offset, $embed)
...
try {
    $result = $apiInstance->getDocuments($limit, $offset, $embed);
    print_r($result);
} catch (Exception $e) {
...
# **updateDocument**
> \Swagger\Client\Model\ModelDocument updateDocument($id, $body)
...
try {
    $result = $apiInstance->updateDocument($id, $body);
    print_r($result);
} catch (Exception $e) {
...
try {
    $apiInstance->updateDocumentStatusToTrashed($id);
} catch (Exception $e) {
