...
# **addVoucher**
> \Swagger\Client\Model\ModelVoucher addVoucher($body)
...
try {
    $result = $apiInstance->addVoucher($body);
    print_r($result);
} catch (Exception $e) {
...
# **getVouchers**
> \Swagger\Client\Model\ModelVoucher getVouchers($limit, $offset, $embed)
...
try {
    $result = $apiInstance->getVouchers($limit, $offset, $embed);
    print_r($result);
} catch (Exception $e) {
...
# **saveVoucher**
> \Swagger\Client\Model\ModelVoucherFactory saveVoucher($body)
...
try {
    $result = $apiInstance->saveVoucher($body);
    print_r($result);
} catch (Exception $e) {
...
[**\Swagger\Client\Model\ModelVoucherFactory**](../Model/ModelVoucherFactory.md)
...
# **updateVoucher**
> \Swagger\Client\Model\ModelVoucher updateVoucher($id, $body)
...
try {
    $result = $apiInstance->updateVoucher($id, $body);
    print_r($result);
} catch (Exception $e) {
...
try {
    $apiInstance->voucherExtractThumb($file_name);
} catch (Exception $e) {
...
> \Swagger\Client\Model\ModelAccountingType voucherGetAccountingTypes($id, $embed)
...
try {
    $result = $apiInstance->voucherGetAccountingTypes($id, $embed);
    print_r($result);
} catch (Exception $e) {
...
> \Swagger\Client\Model\ModelVoucher voucherGetDependingRecurringVouchers($id, $embed)
...
try {
    $result = $apiInstance->voucherGetDependingRecurringVouchers($id, $embed);
    print_r($result);
} catch (Exception $e) {
...
try {
    $apiInstance->voucherGetTaxGroups($id, $show_total_sum, $with_corrections);
} catch (Exception $e) {
...
# **voucherMarkAsOpen**
> \Swagger\Client\Model\ModelVoucher voucherMarkAsOpen($id)
...
try {
    $result = $apiInstance->voucherMarkAsOpen($id);
    print_r($result);
} catch (Exception $e) {
...
# **voucherMarkAsPaid**
> \Swagger\Client\Model\ModelVoucher voucherMarkAsPaid($id, $body)
...
try {
    $result = $apiInstance->voucherMarkAsPaid($id, $body);
    print_r($result);
} catch (Exception $e) {
...
# **voucherRefundAmount**
> \Swagger\Client\Model\ModelVoucherLog voucherRefundAmount($id, $body)
...
try {
    $result = $apiInstance->voucherRefundAmount($id, $body);
    print_r($result);
} catch (Exception $e) {
...
[**\Swagger\Client\Model\ModelVoucherLog**](../Model/ModelVoucherLog.md)
...
> \Swagger\Client\Model\ModelVoucherFactory voucherUploadTempFile($file)
...
try {
    $result = $apiInstance->voucherUploadTempFile($file);
    print_r($result);
} catch (Exception $e) {
