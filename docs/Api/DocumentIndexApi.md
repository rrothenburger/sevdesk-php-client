# Swagger\Client\DocumentIndexApi
...
# **getDocumentIndexes**
> \Swagger\Client\Model\ModelDocumentIndex getDocumentIndexes($limit, $offset, $embed)
...
$apiInstance = new Swagger\Client\Api\DocumentIndexApi(
...
try {
    $result = $apiInstance->getDocumentIndexes($limit, $offset, $embed);
    print_r($result);
} catch (Exception $e) {
...
[**\Swagger\Client\Model\ModelDocumentIndex**](../Model/ModelDocumentIndex.md)
