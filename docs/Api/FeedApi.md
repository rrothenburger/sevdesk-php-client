...
# **addFeed**
> \Swagger\Client\Model\ModelFeed addFeed($body)
...
$apiInstance = new Swagger\Client\Api\FeedApi(
...
try {
    $result = $apiInstance->addFeed($body);
    print_r($result);
} catch (Exception $e) {
...
# **getFeeds**
> \Swagger\Client\Model\ModelFeed getFeeds($limit, $offset, $embed)
...
try {
    $result = $apiInstance->getFeeds($limit, $offset, $embed);
    print_r($result);
} catch (Exception $e) {
...
# **updateFeed**
> \Swagger\Client\Model\ModelFeed updateFeed($id, $body)
...
try {
    $result = $apiInstance->updateFeed($id, $body);
    print_r($result);
} catch (Exception $e) {
