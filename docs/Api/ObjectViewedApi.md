# Swagger\Client\ObjectViewedApi
...
# **getObjectViewed**
> \Swagger\Client\Model\ModelObjectViewed getObjectViewed($limit, $offset, $embed)
...
$apiInstance = new Swagger\Client\Api\ObjectViewedApi(
...
try {
    $result = $apiInstance->getObjectViewed($limit, $offset, $embed);
    print_r($result);
} catch (Exception $e) {
...
[**\Swagger\Client\Model\ModelObjectViewed**](../Model/ModelObjectViewed.md)
