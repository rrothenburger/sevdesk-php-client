...
try {
    $apiInstance->accountingContactIsAvailableDebitorCreditorNumber($contact_id, $contact_object_name, $debitor_number, $creditor_number);
} catch (Exception $e) {
...
> \Swagger\Client\Model\ModelAccountingContact addAccountingContact($body)
...
try {
    $result = $apiInstance->addAccountingContact($body);
    print_r($result);
} catch (Exception $e) {
...
[**\Swagger\Client\Model\ModelAccountingContact**](../Model/ModelAccountingContact.md)
...
> \Swagger\Client\Model\ModelAccountingContact getAccountingContacts($limit, $offset, $embed)
...
try {
    $result = $apiInstance->getAccountingContacts($limit, $offset, $embed);
    print_r($result);
} catch (Exception $e) {
...
> \Swagger\Client\Model\ModelAccountingContact updateAccountingContact($id, $body)
...
try {
    $result = $apiInstance->updateAccountingContact($id, $body);
    print_r($result);
} catch (Exception $e) {
