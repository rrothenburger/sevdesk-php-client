...
# **addLetter**
> \Swagger\Client\Model\ModelLetter addLetter($body)
...
try {
    $result = $apiInstance->addLetter($body);
    print_r($result);
} catch (Exception $e) {
...
[**\Swagger\Client\Model\ModelLetter**](../Model/ModelLetter.md)
...
# **getLetters**
> \Swagger\Client\Model\ModelLetter getLetters($limit, $offset, $embed)
...
try {
    $result = $apiInstance->getLetters($limit, $offset, $embed);
    print_r($result);
} catch (Exception $e) {
...
# **letterSendBy**
> \Swagger\Client\Model\ModelLetter letterSendBy($id, $body)
...
try {
    $result = $apiInstance->letterSendBy($id, $body);
    print_r($result);
} catch (Exception $e) {
...
# **updateLetter**
> \Swagger\Client\Model\ModelLetter updateLetter($id, $body)
...
try {
    $result = $apiInstance->updateLetter($id, $body);
    print_r($result);
} catch (Exception $e) {
