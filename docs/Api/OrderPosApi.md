...
# **addOrderPos**
> \Swagger\Client\Model\ModelOrderPos addOrderPos($body)
...
try {
    $result = $apiInstance->addOrderPos($body);
    print_r($result);
} catch (Exception $e) {
...
# **getOrderPositions**
> \Swagger\Client\Model\ModelOrderPos getOrderPositions($limit, $offset, $embed)
...
try {
    $result = $apiInstance->getOrderPositions($limit, $offset, $embed);
    print_r($result);
} catch (Exception $e) {
...
# **updateOrderPos**
> \Swagger\Client\Model\ModelOrderPos updateOrderPos($id, $body)
...
try {
    $result = $apiInstance->updateOrderPos($id, $body);
    print_r($result);
} catch (Exception $e) {
