...
# **addOrder**
> \Swagger\Client\Model\ModelOrder addOrder($body)
...
[**\Swagger\Client\Model\ModelOrder**](../Model/ModelOrder.md)
...
# **copyOrder**
> \Swagger\Client\Model\ModelOrder copyOrder($id)
...
try {
    $result = $apiInstance->copyOrder($id);
    print_r($result);
} catch (Exception $e) {
...
# **duplicateOrder**
> \Swagger\Client\Model\ModelOrder duplicateOrder($id)
...
try {
    $result = $apiInstance->duplicateOrder($id);
    print_r($result);
} catch (Exception $e) {
...
try {
    $apiInstance->getNextOrderNumber($order_type, $use_next_number);
} catch (Exception $e) {
...
# **getOrderDiscounts**
> \Swagger\Client\Model\ModelDiscounts getOrderDiscounts($id, $limit, $offset, $embed)
...
try {
    $result = $apiInstance->getOrderDiscounts($id, $limit, $offset, $embed);
    print_r($result);
} catch (Exception $e) {
...
# **getOrders**
> \Swagger\Client\Model\ModelOrder getOrders($limit, $offset, $embed)
...
try {
    $result = $apiInstance->getOrders($limit, $offset, $embed);
    print_r($result);
} catch (Exception $e) {
...
# **orderChangeStatus**
> \Swagger\Client\Model\ModelOrder orderChangeStatus($id, $body)
...
try {
    $result = $apiInstance->orderChangeStatus($id, $body);
    print_r($result);
} catch (Exception $e) {
...
> \Swagger\Client\Model\ModelOrder orderGetMainOrderByLogs($id)
...
try {
    $result = $apiInstance->orderGetMainOrderByLogs($id);
    print_r($result);
} catch (Exception $e) {
...
try {
    $apiInstance->orderGetPdf($id, $prevent_send_by);
} catch (Exception $e) {
...
# **orderGetPositions**
> \Swagger\Client\Model\ModelOrderPos orderGetPositions($id, $with_optional, $only_chargeable, $limit, $offset, $embed)
...
try {
    $result = $apiInstance->orderGetPositions($id, $with_optional, $only_chargeable, $limit, $offset, $embed);
    print_r($result);
} catch (Exception $e) {
...
try {
    $apiInstance->orderGetRelatedObjects($id, $include_itself, $sort_by_type, $embed);
} catch (Exception $e) {
...
try {
    $apiInstance->orderGetTax($id, $foreign_currency);
} catch (Exception $e) {
...
try {
    $apiInstance->orderGetTotal($id, $foreign_currency);
} catch (Exception $e) {
...
# **orderSendBy**
> \Swagger\Client\Model\ModelOrder orderSendBy($id, $send_type)
...
try {
    $result = $apiInstance->orderSendBy($id, $send_type);
    print_r($result);
} catch (Exception $e) {
...
# **sendOrderViaEmail**
> \Swagger\Client\Model\ModelEmail sendOrderViaEmail($id, $body)
...
try {
    $result = $apiInstance->sendOrderViaEmail($id, $body);
    print_r($result);
} catch (Exception $e) {
...
# **sendOrderViaPost**
> \Swagger\Client\Model\ModelOrder sendOrderViaPost($id)
...
try {
    $result = $apiInstance->sendOrderViaPost($id);
    print_r($result);
} catch (Exception $e) {
...
# **updateOrder**
> \Swagger\Client\Model\ModelOrder updateOrder($id, $body)
