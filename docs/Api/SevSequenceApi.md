...
# **getSevSequence**
> \Swagger\Client\Model\ModelSevSequence getSevSequence($limit, $offset, $embed)
...
$apiInstance = new Swagger\Client\Api\SevSequenceApi(
...
try {
    $result = $apiInstance->getSevSequence($limit, $offset, $embed);
    print_r($result);
} catch (Exception $e) {
...
[**\Swagger\Client\Model\ModelSevSequence**](../Model/ModelSevSequence.md)
