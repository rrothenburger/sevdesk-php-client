# Swagger\Client\AccountingChartApi
...
# **addAccountingChart**
> \Swagger\Client\Model\ModelAccountingChart addAccountingChart($body)
...
[**\Swagger\Client\Model\ModelAccountingChart**](../Model/ModelAccountingChart.md)
...
# **getAccountingChart**
> \Swagger\Client\Model\ModelAccountingChart getAccountingChart($limit, $offset)
...
try {
    $result = $apiInstance->getAccountingChart($limit, $offset);
    print_r($result);
} catch (Exception $e) {
...
> \Swagger\Client\Model\ModelAccountingChart updateAccountingChart($id, $body)
...
try {
    $result = $apiInstance->updateAccountingChart($id, $body);
    print_r($result);
} catch (Exception $e) {
