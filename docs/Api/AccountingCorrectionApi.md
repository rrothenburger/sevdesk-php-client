# Swagger\Client\AccountingCorrectionApi
...
> \Swagger\Client\Model\ModelAccountingCorrection addAccountingCorrection($body)
...
$apiInstance = new Swagger\Client\Api\AccountingCorrectionApi(
...
try {
    $result = $apiInstance->addAccountingCorrection($body);
    print_r($result);
} catch (Exception $e) {
...
[**\Swagger\Client\Model\ModelAccountingCorrection**](../Model/ModelAccountingCorrection.md)
...
> \Swagger\Client\Model\ModelAccountingCorrection getAccountingCorrections($limit, $offset, $embed)
...
try {
    $result = $apiInstance->getAccountingCorrections($limit, $offset, $embed);
    print_r($result);
} catch (Exception $e) {
...
> \Swagger\Client\Model\ModelAccountingCorrection updateAccountingCorrection($id, $body)
...
try {
    $result = $apiInstance->updateAccountingCorrection($id, $body);
    print_r($result);
} catch (Exception $e) {
