...
# **addInvoiceLog**
> \Swagger\Client\Model\ModelInvoiceLog addInvoiceLog($body)
...
$apiInstance = new Swagger\Client\Api\InvoiceLogApi(
...
try {
    $result = $apiInstance->addInvoiceLog($body);
    print_r($result);
} catch (Exception $e) {
...
# **getInvoiceLogs**
> \Swagger\Client\Model\ModelInvoiceLog getInvoiceLogs($limit, $offset, $embed)
...
try {
    $result = $apiInstance->getInvoiceLogs($limit, $offset, $embed);
    print_r($result);
} catch (Exception $e) {
...
# **updateInvoiceLog**
> \Swagger\Client\Model\ModelInvoiceLog updateInvoiceLog($id, $body)
...
try {
    $result = $apiInstance->updateInvoiceLog($id, $body);
    print_r($result);
} catch (Exception $e) {
