...
try {
    $result = $apiInstance->exportContactCsv($contact_id, $contact_object_name, $download);
    print_r($result);
} catch (Exception $e) {
...
try {
    $result = $apiInstance->exportContactListCsv($sev_query_model_name, $sev_query_object_name, $download, $sev_query_limit, $sev_query_filter_depth);
    print_r($result);
} catch (Exception $e) {
...
$enshrine = "false"; // string | Specify if you want to enshrine all models which were included in the export
$download = true; // bool | Specifies if the document is downloaded

try {
    $result = $apiInstance->exportDatev($scope, $start, $end, $with_enshrined, $enshrine, $download);
    print_r($result);
} catch (Exception $e) {
 ...
 **enshrine** | **string**| Specify if you want to enshrine all models which were included in the export | [default to false]
 **download** | **bool**| Specifies if the document is downloaded | [optional] [default to true]
...
try {
    $result = $apiInstance->exportDatevZip($scope, $start, $end, $with_enshrined, $download);
    print_r($result);
} catch (Exception $e) {
...
try {
    $result = $apiInstance->exportInventoryPartLogList($sev_query_model_name, $sev_query_object_name, $download, $sev_query_limit, $sev_query_filter_part_id, $sev_query_filter_part_object_name);
    print_r($result);
} catch (Exception $e) {
...
try {
    $result = $apiInstance->exportInvoiceCsv($sev_query_model_name, $sev_query_object_name, $download, $sev_query_limit);
    print_r($result);
} catch (Exception $e) {
...
try {
    $result = $apiInstance->exportInvoiceZip($sev_query_model_name, $sev_query_object_name, $download, $sev_query_limit);
    print_r($result);
} catch (Exception $e) {
...
try {
    $result = $apiInstance->exportPartCsv($sev_query_model_name, $sev_query_object_name, $download, $sev_query_limit);
    print_r($result);
} catch (Exception $e) {
...
try {
    $result = $apiInstance->exportPebe($scope, $start, $end, $with_enshrined, $enshrine, $download);
    print_r($result);
} catch (Exception $e) {
...
try {
    $result = $apiInstance->exportTransactionsCsv($sev_query_filter_register, $sev_query_model_name, $sev_query_object_name, $sev_query_order_entry_date, $download, $check_account_id, $check_account_object_name, $sev_query_limit);
    print_r($result);
} catch (Exception $e) {
...
try {
    $result = $apiInstance->exportVoucherListCsv($sev_query_model_name, $sev_query_object_name, $download, $sev_query_limit, $sev_query_filter_start_date, $sev_query_filter_voucher_type);
    print_r($result);
} catch (Exception $e) {
...
try {
    $result = $apiInstance->exportVoucherZip($sev_query_model_name, $sev_query_object_name, $download, $sev_query_limit, $sev_query_filter_start_date, $sev_query_filter_voucher_type);
    print_r($result);
} catch (Exception $e) {
